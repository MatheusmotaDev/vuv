...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="form-section">
            ...
            <form method="post" action="{{ route('profile.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name', auth()->user()->name) }}" autocomplete="name">
                    @error('name')
        ...
        <div class="form-section">
            ...
            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirm-user-deletion-modal">Deletar a conta</button>
        </div>
    </div>
