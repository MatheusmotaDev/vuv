<x-guest-layout>
    <form method="POST" action="{{ route('seller.store') }}">
        ...
        <div class="mt-4">
            <x-input-label for="legal_id" :value="__('Cpf / Cnpj')" />
            <x-text-input id="legal_id" class="block mt-1 w-full" type="text" name="legal_id" :value="old('legal_id')" required />
        ...
        <div class="mt-4">
            ...
            required placeholder="(ddd) 9xxxx-xxxx" />
