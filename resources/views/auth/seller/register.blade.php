        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form method="POST" action="{{ route('seller.store') }}">
                    ...
                    <div class="mt-4">
                        <label for="legal_id" class="form-label">{{ __('Insira seu CPF ou CNPJ') }}</label>
                    ...
                    <!-- Password -->
                    <div class="mt-4">
                        <label for="password" class="form-label">{{ __('Digite sua senha de 8 digitos ou mais') }}</label>
                    ...
                    <a class="underline text-sm hover:text-gray-900 text-white" href="{{ route('options') }}">
                     {{ __('Já é registrado?') }}
                        ...
                        <button type="submit" class="btn btn-dark btn-lg ms-4">{{ __('Registrar') }}</button>
                    </div>
                </form>
            </div>
        </div>
