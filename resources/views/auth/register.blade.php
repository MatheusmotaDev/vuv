...
<div class="vuv-auth-wrapper">
    <div class="vuv-auth-card vuv-auth-card-wide">
        ...
        <h2 class="vuv-auth-title">Criar sua conta</h2>
        <p class="vuv-auth-subtitle">Cadastre-se como cliente para começar a fazer cotações</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div class="vuv-form-group">
                    <label for="legal_id" class="vuv-form-label">{{ __('CPF') }}</label>
