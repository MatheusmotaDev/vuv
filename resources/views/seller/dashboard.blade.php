  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
      <div class="card" style="max-width: 300px; margin: 0 auto;">
        ...
        <div class="card-body">
          <p class="card-text" style="text-align: center;">Se você acabou de chegar na plataforma, preparamos um tutorial só para você!</p>
          <div class="text-center">
    ...
    <div class="col-md-6 mb-4">
      <div class="card" style="max-width: 300px; margin: 0 auto;">
        ...
        <div class="card-body">
          <p class="card-text" style="text-align: center;">Se você deseja procurar uma cotação em aberto para fazer propostas, porfavor clique abaixo</p>
          <div class="text-center">
