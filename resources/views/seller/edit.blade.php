        ...
        <div class="vuv-section vuv-animate-fadeInUp vuv-delay-2">
            ...
            <form method="post" action="{{ route('password.update') }}">
                ...
                <div class="vuv-form-group">
                    ...
                    <input type="password" name="current_password" id="current_password" class="vuv-form-control vuv-form-control-light">
                ...
                <div class="vuv-form-group">
                    ...
                    <input type="password" name="new_password" id="new_password" class="vuv-form-control vuv-form-control-light">
                ...
                <div class="vuv-form-group">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" class="vuv-form-control vuv-form-control-light">
